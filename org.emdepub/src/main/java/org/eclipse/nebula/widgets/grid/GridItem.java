...
public class GridItem extends Item {
	...
	public int getHeight() {
		...
		/* RANGE */
		if (parent.isFileList() && !isMeasured) {
			
			//int h1 = height;
			
			GridColumn column0 = parent.getColumns()[0];
			height = column0.getCellRenderer().computeSize(parent.sizingGC, column0.getWidth(), SWT.DEFAULT, this).y;
//			if (height > 24) {
//				height = height + 3;
//			}
			height = height + 3;
...
//			parent.hasDifferingHeights = true;
			...
			//L.p(parent.getIndexOfItem(this) + " --- " + h1 + " - " + height + " - " + this.getText(0));
		}
