...
public class Grid extends Canvas {
	...
	private int horizontalScrollCompensate = 0;
	...
	public Grid(Composite parent, int style) {
		...
		/* MOD */
		itemHeight = this.sizingGC.getFontMetrics().getHeight() + 6;
	}
...
//	public void setItemDefaultHeight() {
//		checkWidget();
//		/* RANGE */
//		userModifiedItemHeight = true;
//		int height =  
...
//	}
		...
		/* RANGE */
			...
			for (int idx = startIndex; idx <= endIndex; idx++) {
				...
				if (currItem.isVisible()) {
					...
					range.height += currItem.getHeight();
					range.rows++;
					if (range.height > clientArea.height) {
						break;
					}
				}
			}
	...
	private RowRange getRowRange(int startIndex, int availableHeight, boolean forceEndCompletelyInside, boolean inverse) {
		...
		if (isTree || hasDifferingHeights || isFileList) {
	...
	public void showItemAtTop(GridItem item) {
		checkWidget();
	...
	private void updateScrollbars() {
		...
		if (vScroll.getVisible()) {
			...
			if ((!hasDifferingHeights) && (!isFileList)) {
...
/*					
					final int finalNewSelection = Grid.this.indexOf(newSelection);
					final PaintListener afterRefreshPaintListener = new PaintListener() {
						@Override
						public void paintControl(PaintEvent paintEvent) {
							
							Grid.this.setTopIndex(finalNewSelection);
							Grid.this.removePaintListener(this);
						}
					};
					Grid.this.addPaintListener(afterRefreshPaintListener);
*/
				}
			}
			else {
...
//			/* ======================================================================================= */
//			if (isFileList && (e.detail != 111)) {
//				if (items.size() == 0) {
//					return;
//				}
//				RowRange range1 = getRowRange(getTopIndex(), getVisibleGridHeight(), true, false);
//
//				int focusIndex = -1;
//				if ((e.stateMask & SWT.MOD1) == SWT.MOD1) {
//					focusIndex = getIndexOfItem(focusItem);
//				}
//				int rangeEndIndex = range1.endIndex;
//				if ((getSelectionIndex() == rangeEndIndex) || (focusIndex == rangeEndIndex)) {
//					
//					if (rangeEndIndex == items.size() - 1) {
//						return;
//					}
//					setTopIndex(rangeEndIndex + 1);
//
//					final PaintListener topIndexPaintListener = new PaintListener() {
//						@Override
//						public void paintControl(PaintEvent paintEvent) {
//							
//							Grid.this.removePaintListener(this);
...
//						}
//					};
//					Grid.this.addPaintListener(topIndexPaintListener);
//					return;
//				}
//			}
//			/* ======================================================================================= */
...
//	}
	...
	/* RANGE */
	public void setFileList(boolean isFileList) {
	...
	public int getHorizontalScrollCompensate() {
		return horizontalScrollCompensate;
	}

	public void setHorizontalScrollCompensate(int horizontalScrollCompensate) {
		this.horizontalScrollCompensate = horizontalScrollCompensate;
	}
