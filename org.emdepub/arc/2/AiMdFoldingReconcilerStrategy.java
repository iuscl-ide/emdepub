...
public class AiMdFoldingReconcilerStrategy implements IReconcilingStrategy, IReconcilingStrategyExtension {
	...
	public String toStringu(Object object) {
	...
	public void reconcile(DirtyRegion dirtyRegion, IRegion subRegion) {
		...
		System.out.println("dirtyRegion " + toStringu(dirtyRegion) + ", subRegion: " + subRegion + ", line: " + document.getLineOfOffset(dirtyRegion.getOffset()));
		
//		if (isWorking.get()) {
//			isAskingCancellation.set(true);
//		}
//		long st = System.currentTimeMillis();
//		if (document.get().equals(oldDocument)) {
//			System.out.println("dirtyRegion " + (System.currentTimeMillis() - st));
//			return;
//		}
...
//	
	...
	private List<Position> getNewPositionsOfAnnotations() {
		...
		tmDocumentModel.addModelTokensChangedListener(event -> {
